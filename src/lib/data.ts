...
const rawData = `Date	Invoice No	G/L Code	Title	Amount	Qty 	unit 	Rate /Unit	Vendor	Description	Notes	Receipt
...
7/25/25	VLG455/25	5002-Bore Construction	Bore Construction	₹45,200	20	EA	₹45,180	Vijay Lakshmi Engineering 	5' Supreme C Singe Pipes	Bore - Materials 	https://picsum.photos/seed/receipt1/800/1200
7/25/25	VLG455/25	5002-Bore Construction	Bore Construction	₹37,000	1	EA	₹37,000	Vijay Lakshmi Engineering 	5HP Pump Set 	Bore - Materials 	https://picsum.photos/seed/receipt2/800/1200
...
7/27/25	Nil	5002-Bore Construction	Bore Construction	₹22,000	200	FT	₹110	Lakshmi Bore Works - Ravulapalem 	Drilling Bore - 6" Bore @ 200 Feet @110/Foot 	Bore - Services 	https://picsum.photos/seed/receipt3/800/1200
...
export const transactions: Transaction[] = lines.map((line, index) => {
    ...
    return {
        ...
        notes: columns[10],
        category: category,
        receiptUrl: columns[11] && columns[11].startsWith('http') ? columns[11] : undefined
    };
});
