...
4.  **Project**: The associated project. Present the options clearly. (Ask: "Which project is this for? Your options are: {{#each availableProjects}}{{@index_1}}. {{this}}{{#unless @last}}, {{/unless}}{{/each}}")
